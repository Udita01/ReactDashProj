           ...
           <div className='row'>
                ...
                <div className='col-sm-6'>
                    ...
                    <p id='fnerr'style={{color:'red', fontSize:'10px'}}></p>
                        ...
                        <div><label>Select Your Gender: </label>
                <input type='radio' name='gender' value="male" checked={stud.gender==="male"} onChange={(e)=>inputChangeHandler(e)} /> Male {" "}&nbsp;
                <input type='radio' name='gender' value="female" checked={stud.gender==="female"} onChange={(e)=>inputChangeHandler(e)} /> Female</div><br />
